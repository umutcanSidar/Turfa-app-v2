...
from .views import CandidateFormView, CandidateServiceDetailsView
from home.views import ContactView, AboutView, BlogView, BlogDetailView, HomeView
...
urlpatterns = [
    ...
    path("services/<slug:slug>/",CandidateServiceDetailsView.as_view(), name="candidate_services_detail"),
